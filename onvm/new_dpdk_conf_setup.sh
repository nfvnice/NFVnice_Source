...
#mode=0 => Single port connection Flashstack-2 (P1P1=08:00.0) <---> Flashstack-3 (P1P1=08:00.0)
#mode=1 => Two ports connection   Flashstack-2 (P2P1=05:00.0) <---> Flashstack-3 (P2P1=05:00.0) and Flashstack-3(P1P2=08:00.1) <---> Flashstack-4(P1P2=08:00.1) 
